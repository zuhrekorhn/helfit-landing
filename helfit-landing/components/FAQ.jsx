...
const FAQS = [
  ...
  { q: 'AI Koçlar nasıl çalışıyor?', a: '4 farklı karakter var: Caner (Motivasyon), Melis (Tarif), Ege (Spor), Özge (Alışkanlık). Her biri danışanın anamnez bilgilerini, diyet planını ve konuşma geçmişini bilerek 7/24 kişiselleştirilmiş yanıtlar verir.' },
  { q: 'Mobil uygulama var mı?', a: 'Evet, iOS ve Android\'de ücretsiz kullanılabilir. Danışanlar diyet planı görüntüleme, öğün işaretleme, randevu alma, diyetisyenle mesajlaşma ve AI Koç erişimi için kullanabilir.' },
